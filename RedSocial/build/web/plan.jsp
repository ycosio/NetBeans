...
<form name="frm"  method="post"> 
       <%
        ...
        while(resultado.next())
        {
            ...
            resultado3.next();
            nombreAcademia = resultado3.getString("nombre");
            

                out.println("<div contentEditable=false ALIGN='JUSTIFY' style='width: calc(100% - 1px);height: 150px;border: 1px solid #999;background-color: white;padding: 14px;margin-bottom: 10px; overflow: auto;white-space: nowrap;'><strong style ='color:#005BB5'><strong style ='color:#005BB5;font-size: large'>");
                ...
                out.println("<button style='font-weight:bold;' type='submit' class='btn btn-info btn-sm' value='"+idplaneacion+"'"); 
