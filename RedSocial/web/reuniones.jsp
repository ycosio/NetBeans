...
<%-- ----------------------------------------------------------------------------------------------- --%>
      ...
      <section id="main-content">
          ...
          <%
            ...
            conexion.conecta();
            ResultSet resultado=conexion.consulta("select idreunion, fecha, titulo, lugar, estado from reunion where idacademia='" + academia + "';");
            ...
            while(resultado.next())
            {
                ...
                out.print(fechatemp);
                out.println("</span> </h4> <h4 style='margin-top: 0.5cm;'>"); 
                out.print(titulo);
                out.println("</strong></h4><h5 class='text-muted' style= 'color:black;'>Lugar: " + lugar + "  -   Estado:" + estado); 
               
                if(estado.equals(pendiente))
                    out.println("</h5><button type='submit' name='valor' value='Minuta-Reunion" + reunion + ".pdf' class='btn btn-success btn-sm' style='margin-right: 7px;font-weight:bold;' ' disabled>Descargar</button>");
                else
