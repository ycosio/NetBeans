...
<%-- ----------------------------------------------------------------------------------------------- --%>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Ingresa los datos del nuevo usuario</h3>
 ...
 <form class="form-horizontal" role="form" name="agregarMiembro" method="post" style="color: black">
  ...
  <%--
    ...
    <label class="col-lg-2 control-label">¿Más de un Rol?</label>
    <div class="col-lg-10">
    <input type="checkbox" name="check" id="check" value="1" onchange="javascript:showContent()" /> Clic para agregar más
    </div> 
...
<div id="content" style="display: none;">
    ...
    <div class="col-lg-10">
        <h4><strong>Segundo Rol</label><strong><h4>
        <br>
    </div>
 ...
 <label class="col-lg-2 control-label">Tipo</label>
    <div class="col-lg-10">
        <SELECT NAME="tipoDoble" SIZE=1 class="form-control"> 
            <OPTION VALUE="Presidente">Presidente</OPTION>
            <OPTION VALUE="Profesor">Profesor</OPTION>
            <OPTION VALUE="Secretario">Secretario</OPTION>
        </SELECT> 
 ...
 <label class="col-lg-2 control-label">Programa educativo</label>
    <div class="col-lg-10">
        <SELECT NAME="progEducativoDoble" SIZE=1 class="form-control" onchange="academia(document.agregarMiembro.academia2.options.selectedIndex)"> 
            <OPTION VALUE="Ingenieria en Telematica">Ingenieria en Telematica</OPTION>
            <OPTION VALUE="Ingenieria de Software">Ingenieria de Software</OPTION>
        </SELECT> 
        <br>
  ...
  <%--
    ...
    <label class="col-lg-2 control-label">Academia</label>
    <div class="col-lg-10">
        <SELECT NAME="idAcademiaDoble" SIZE=1 class="form-control" onchange="academia(this.options.selectedIndex)"> 
            <OPTION VALUE="1">Ciencias Básicas</OPTION>
            <OPTION VALUE="2">Redes y Telecomunicaciones</OPTION>
            <OPTION VALUE="3">Arquitectura de Computadoras</OPTION>
            <OPTION VALUE="4">Software</OPTION>
    ...
    <label class="col-lg-2 control-label">Materia</label>
    <div class="col-lg-10">
        <SELECT name="materiaDoble" SIZE=1 class="form-control"> 
            <OPTION VALUE="Fisica">Fisica</OPTION>
            <OPTION VALUE="Matematicas para ingenieria">Matematicas para ingenieria</OPTION>
            <OPTION VALUE="Electronica digital">Electronica digital</OPTION>
            <OPTION VALUE="Calculo diferencial e integral">Calculo diferencial e integral</OPTION>
    ...
    <div class="col-lg-offset-2 col-lg-10">
     ...
     <%
       ...
       String nombre = request.getParameter("nombre");
        ...
        String tipoDoble = request.getParameter("tipoDoble");
        String idAcademiaDoble = request.getParameter("idAcademiaDoble");
        String progEducativoDoble = request.getParameter("progEducativoDoble");
        String materiaDoble = request.getParameter("materiaDoble"); 
        
        if(tipoDoble != null && tipoDoble != null && tipoDoble != null && tipoDoble != null)
        conexion.ejecuta("INSERT INTO sudoprofesor VALUES ('"+ nCuenta +"','" +tipoDoble+ "','"    +idAcademiaDoble+ "','" + progEducativoDoble + "','" + materiaDoble + "');");
