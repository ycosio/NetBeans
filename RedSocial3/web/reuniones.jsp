...
<%-- ----------------------------------------------------------------------------------------------- --%>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> ¡<% out.print(user);%>, estás son tus ultimas reuniones!</h3>
          ...
          <%
            ...
            while(resultado.next())
            {
                ...
                out.print(lugar);
                out.println("</h5><button type='submit' name='valor' value='Minuta-Reunion" + reunion + ".pdf' class='btn btn-success btn-sm' style='margin-right: 7px;'>Ver</button>");
                
                if(tipos[4].equals(session.getAttribute("varTipo")))
                {
                out.println("<button type='submit' class='btn btn-info btn-sm' value=" + reunion);  
                out.print(i);
                out.println(" name=" + i);
                out.print(i);
