 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8080/CalculatorWSApplication/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://calculator/", "CalculatorWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorWSApplication/CalculatorWS?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://calculator/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
