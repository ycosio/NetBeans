...
<%
            ...
            conexion.ejecuta("INSERT INTO reunion (idlista,idacademia,fecha,lugar,semestre,titulo,idminuta,estado, progEducativo) VALUES ('" + idlista + "','" + academia + "','" + fecha + "','" + lugar + "','" + semestre + "','" + titulo + "','" + idminuta + "', 'Pendiente' ,'" + progEducativo + "');");
