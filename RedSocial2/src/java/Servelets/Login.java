...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String academia = info[0];
            String tipo2 = info[1];
            progEducativo = info[2];
            materia = info[3];
            HttpSession sesion = request.getSession();
            
            //Cuando pasé el elijeRol ya tenia el USER y el NCUENTA
            
            sesion.setAttribute("varTipo", tipo2);
            sesion.setAttribute("varAcademia", academia);
...
//la consulta SQL
            ...
            try {
                ...
                sql = "select no_cuenta from sudoprofesor where no_cuenta='" + nCuenta + "' ";
                ...
                while (resultado.next())
                {
                    ...
                    sesion.setAttribute("varAcademia", idAcademia);
                        ...
                        response.sendRedirect("elijeRol.jsp");
                    }
                }
